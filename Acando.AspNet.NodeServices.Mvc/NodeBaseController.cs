namespace Acando.AspNet.NodeServices.Mvc
{
    ...
    public class NodeBaseController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected async Task<ActionResult> NodeResultAsync(object globalData, object routeData, string cacheKey = "", int cacheTimeoutSeconds = 0)
        {
            return await _builder.NodeResultAsync(globalData, routeData, cacheKey, cacheTimeoutSeconds);
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected async Task<ActionResult> PartialNodeResultAsync(object globalData, object routeData, string cacheKey = "", int cacheTimeoutSeconds = 0)
        {
            return await _builder.PartialNodeResultAsync(globalData, routeData, cacheKey, cacheTimeoutSeconds);
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected async Task<ActionResult> PartialNodeResultEntryFileAsync(string entryFilePath, object globalData, object routeData)
        {
